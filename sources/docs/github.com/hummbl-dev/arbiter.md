# Source: https://github.com/hummbl-dev/arbiter
...
[Branches](https://github.com/hummbl-dev/arbiter/branches) [Tags](https://github.com/hummbl-dev/arbiter/tags)
...
[105 Commits](https://github.com/hummbl-dev/arbiter/commits/main/)
...
[.githooks](https://github.com/hummbl-dev/arbiter/tree/main/.githooks '.githooks')
...
[.github](https://github.com/hummbl-dev/arbiter/tree/main/.github '.github')
...
[\_receipts/krineia](https://github.com/hummbl-dev/arbiter/tree/main/_receipts/krineia 'This path skips through empty directories')
...
[audits](https://github.com/hummbl-dev/arbiter/tree/main/audits 'audits')
...
[benchmarks](https://github.com/hummbl-dev/arbiter/tree/main/benchmarks 'benchmarks')
...
[dashboard](https://github.com/hummbl-dev/arbiter/tree/main/dashboard 'dashboard')
...
[docs](https://github.com/hummbl-dev/arbiter/tree/main/docs 'docs')
...
[examples/ci](https://github.com/hummbl-dev/arbiter/tree/main/examples/ci 'This path skips through empty directories')
...
[governance/lexicon](https://github.com/hummbl-dev/arbiter/tree/main/governance/lexicon 'This path skips through empty directories')
...
[src/arbiter](https://github.com/hummbl-dev/arbiter/tree/main/src/arbiter 'This path skips through empty directories')
...
[tests](https://github.com/hummbl-dev/arbiter/tree/main/tests 'tests')
...
[.gitignore](https://github.com/hummbl-dev/arbiter/blob/main/.gitignore '.gitignore')
...
[.pre-commit-config.yaml](https://github.com/hummbl-dev/arbiter/blob/main/.pre-commit-config.yaml '.pre-commit-config.yaml')
...
[AGENTS.md](https://github.com/hummbl-dev/arbiter/blob/main/AGENTS.md 'AGENTS.md')
...
[AUDIT\_PLAN.md](https://github.com/hummbl-dev/arbiter/blob/main/AUDIT_PLAN.md 'AUDIT_PLAN.md')
...
[CHANGELOG.md](https://github.com/hummbl-dev/arbiter/blob/main/CHANGELOG.md 'CHANGELOG.md')
...
[CODEOWNERS](https://github.com/hummbl-dev/arbiter/blob/main/CODEOWNERS 'CODEOWNERS')
...
[CODE\_OF\_CONDUCT.md](https://github.com/hummbl-dev/arbiter/blob/main/CODE_OF_CONDUCT.md 'CODE_OF_CONDUCT.md')
...
[CONSTITUTION.md](https://github.com/hummbl-dev/arbiter/blob/main/CONSTITUTION.md 'CONSTITUTION.md')
...
[CONTRIBUTING.md](https://github.com/hummbl-dev/arbiter/blob/main/CONTRIBUTING.md 'CONTRIBUTING.md')
...
[Dockerfile](https://github.com/hummbl-dev/arbiter/blob/main/Dockerfile 'Dockerfile')
...
[KRINEIA.md](https://github.com/hummbl-dev/arbiter/blob/main/KRINEIA.md 'KRINEIA.md')
...
[LICENSE](https://github.com/hummbl-dev/arbiter/blob/main/LICENSE 'LICENSE')
...
[MANIFEST.in](https://github.com/hummbl-dev/arbiter/blob/main/MANIFEST.in 'MANIFEST.in')
...
[README.md](https://github.com/hummbl-dev/arbiter/blob/main/README.md 'README.md')
...
[ROADMAP.md](https://github.com/hummbl-dev/arbiter/blob/main/ROADMAP.md 'ROADMAP.md')
...
[SECURITY.md](https://github.com/hummbl-dev/arbiter/blob/main/SECURITY.md 'SECURITY.md')
...
[agents.yml](https://github.com/hummbl-dev/arbiter/blob/main/agents.yml 'agents.yml')
...
[arbiter\_audit.jsonl](https://github.com/hummbl-dev/arbiter/blob/main/arbiter_audit.jsonl 'arbiter_audit.jsonl')
...
[contribution\_learnings.jsonl](https://github.com/hummbl-dev/arbiter/blob/main/contribution_learnings.jsonl 'contribution_learnings.jsonl')
...
[contributions.jsonl](https://github.com/hummbl-dev/arbiter/blob/main/contributions.jsonl 'contributions.jsonl')
...
[docker-compose.yml](https://github.com/hummbl-dev/arbiter/blob/main/docker-compose.yml 'docker-compose.yml')
...
[hummbl.repo.yaml](https://github.com/hummbl-dev/arbiter/blob/main/hummbl.repo.yaml 'hummbl.repo.yaml')
...
[pyproject.toml](https://github.com/hummbl-dev/arbiter/blob/main/pyproject.toml 'pyproject.toml')
...
[Activity](https://github.com/hummbl-dev/arbiter/activity)

### Stars

[**0** stars](https://github.com/hummbl-dev/arbiter/stargazers)

### Watchers

[**0** watching](https://github.com/hummbl-dev/arbiter/watchers)

### Forks

[**0** forks](https://github.com/hummbl-dev/arbiter/forks)

[Report repository](https://github.com/contact/report-content?content_url=https%3A%2F%2Fgithub.com%2Fhummbl-dev%2Farbiter&report=hummbl-dev+%28user%29)

## [Releases 4](https://github.com/hummbl-dev/arbiter/releases)

[v0.7.0 Latest\\ \\ Jun 14, 2026](https://github.com/hummbl-dev/arbiter/releases/tag/v0.7.0)

[\+ 3 releases](https://github.com/hummbl-dev/arbiter/releases)

## [Packages 0](https://github.com/users/hummbl-dev/packages?repo_name=arbiter)
...
## [Contributors](https://github.com/hummbl-dev/arbiter/graphs/contributors)
...
- [Python 94.6%](https://github.com/hummbl-dev/arbiter/search?l=python)
- [HTML 5.2%](https://github.com/hummbl-dev/arbiter/search?l=html)
- Other 0.2%