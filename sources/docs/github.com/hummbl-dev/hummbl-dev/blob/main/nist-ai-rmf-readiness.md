# Source: https://github.com/hummbl-dev/hummbl-dev/blob/main/nist-ai-rmf-readiness.html
...
[History](https://github.com/hummbl-dev/hummbl-dev/commits/main/nist-ai-rmf-readiness.html)

History

168 lines (158 loc) · 9.76 KB
...
[Raw](https://github.com/hummbl-dev/hummbl-dev/raw/refs/heads/main/nist-ai-rmf-readiness.html)
...
<title\>Have You Mapped Your AI Risk? | HUMMBL</title\>
...
<nav class\="tool-nav no-print"\><a href\="index.html"\>All Tools</a\> | <a href\="eu-ai-act-readiness.html"\>EU AI Act</a\> <a class\="current" href\="nist-ai-rmf-readiness.html"\>NIST RMF</a\> <a href\="iso-42001-readiness.html"\>ISO 42001</a\> <a href\="singapore-agentic-readiness.html"\>Singapore</a\> <a href\="colorado-ai-act-readiness.html"\>Colorado</a\> | <a href\="compliance-calendar.html"\>Calendar</a\> <a href\="governance-crosswalk.html"\>Crosswalk</a\></nav\>
...
<div class\="title"\>Have You Mapped<br\>Your AI Risk?</div\>

<div class\="subtitle"\>The NIST framework federal procurement and regulators increasingly reference</div\>
...
Voluntary but increasingly cited by <strong\>FTC, SEC, and DoD</strong\>.<br\>

Federal procurement contracts reference AI RMF compliance. <strong\>De facto US standard</strong\>.
...
<div class\="stat-box"\><div class\="stat-num"\>4</div\><div class\="stat-label"\>Core functions</div\></div\>

<div class\="stat-box"\><div class\="stat-num"\>19</div\><div class\="stat-label"\>Categories</div\></div\>

<div class\="stat-box"\><div class\="stat-num"\>72</div\><div class\="stat-label"\>Subcategories</div\></div\>
...
<div class\="section-title"\>What the AI RMF Requires</div\>

<div class\="req"\>

<div class\="req-title"\>GOVERN</div\>

<div class\="req-desc"\>Establish AI governance structures, policies, and accountability.</div\>

<div class\="req-article"\>GV 1-6</div\>

</div\>

<div class\="req"\>

<div class\="req-title"\>MAP</div\>

<div class\="req-desc"\>Context and scope AI system risks across the lifecycle.</div\>

<div class\="req-article"\>MP 1-5</div\>

</div\>

<div class\="req"\>

<div class\="req-title"\>MEASURE</div\>

<div class\="req-desc"\>Assess and track AI risks using quantitative and qualitative methods.</div\>

<div class\="req-article"\>MS 1-4</div\>

</div\>

<div class\="req"\>

<div class\="req-title"\>MANAGE</div\>

<div class\="req-desc"\>Prioritize and act on AI risks based on assessment results.</div\>

<div class\="req-article"\>MG 1-4</div\>

</div\>

<div class\="req"\>

<div class\="req-title"\>Generative AI Profile</div\>

<div class\="req-desc"\>Additional risk categories for foundation models and generative AI.</div\>

<div class\="req-article"\>NIST AI 600-1</div\>

</div\>

<div class\="req"\>

<div class\="req-title"\>Crosswalk</div\>

<div class\="req-desc"\>Map AI RMF to ISO 42001, EU AI Act, and sector requirements.</div\>

<div class\="req-article"\>Companion resources</div\>
...
<li\>AI governance board or responsible individual designated</li\>

<li\>AI system inventory with risk classification completed</li\>

<li\>Stakeholder engagement process documented (affected communities)</li\>

<li\>AI risk assessment methodology established</li\>

<li\>Performance metrics and thresholds defined per system</li\>

<li\>Bias testing and fairness evaluation conducted</li\>

<li\>Transparency and explainability measures documented</li\>

<li\>Third-party AI/ML models assessed for risk</li\>

<li\>Incident response process covers AI-specific scenarios</li\>

<li\>Crosswalk to regulatory requirements (EU AI Act, state laws) completed</li\>
...
<p style\="font-size: 10pt; color: #444; margin-bottom: 8px;"\>Organizations seeking defensible AI governance, especially in regulated sectors:</p\>

<div style\="display: grid; grid-template-columns: 1fr 1fr; gap: 4px; font-size: 9.5pt;"\>

<div style\="padding: 4px 8px; background: #f0f0f0; border-radius: 3px;"\>Federal contractors</div\>

<div style\="padding: 4px 8px; background: #f0f0f0; border-radius: 3px;"\>Regulated industries</div\>

<div style\="padding: 4px 8px; background: #f0f0f0; border-radius: 3px;"\>Defense / intelligence</div\>

<div style\="padding: 4px 8px; background: #f0f0f0; border-radius: 3px;"\>Healthcare AI</div\>

<div style\="padding: 4px 8px; background: #f0f0f0; border-radius: 3px;"\>Financial services AI</div\>

<div style\="padding: 4px 8px; background: #f0f0f0; border-radius: 3px;"\>Any org wanting governance</div\>
...
<div class\="cta-sub"\>I'll map your AI systems to the NIST AI RMF and identify your governance gaps.</div\>
