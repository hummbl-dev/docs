# Source: https://github.com/hummbl-dev/hummbl-dev/commits/main/singapore-agentic-readiness.html
...
- #### [feat: rebrand 7 governance tools — dark → light professional](https://github.com/hummbl-dev/hummbl-dev/commit/0200ff4d4e84a2618e0da4f8f208c9a332bdb934 'feat: rebrand 7 governance tools — dark → light professional
 
 Update all assessment, calendar, crosswalk, and readiness HTML files
 to HUMMBL brand v2: #fafafa/#166534 palette, Inter font where applicable.
 
 Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com>')
 
 Show description for 0200ff4
 
 ![Claude (agent)](https://github.githubassets.com/images/gravatars/gravatar-user-420.png?size=32)![claude](https://avatars.githubusercontent.com/u/81847?v=4&size=32)
 ...
 committedMar 26, 2026
 
 [0200ff4](https://github.com/hummbl-dev/hummbl-dev/commit/0200ff4d4e84a2618e0da4f8f208c9a332bdb934)
 
 Copy full SHA for 0200ff4
 

### Commits on Mar 24, 2026

- #### [feat: expand governance offerings — compliance calendar, 5 readiness assessments, crosswalk](https://github.com/hummbl-dev/hummbl-dev/commit/01cc7edb524675c3a438b7a97913f8bd7c5869e6 'feat: expand governance offerings — compliance calendar, 5 readiness assessments, crosswalk
 
 New service portfolio covering 30+ AI governance regulations across
 US, EU, APAC, and international standards bodies.
 
 New pages:
 - compliance-calendar.html: Interactive timeline of all regulations with
 filters, countdowns, sector targeting, and mapped service CTAs
 - governance-crosswalk.html: Cross-framework mapping showing how one
 governance program satisfies NIST + ISO 42001 + EU AI Act + Colorado +
 Singapore simultaneously (70-90% cost savings vs separate programs)
 - colorado-ai-act-readiness.html: SB 24-205 readiness checklist (Jun 2026)
 - iso-42001-readiness.html: AI Management System certification readiness
 - singapore-agentic-readiness.html: Agentic AI governance framework readiness
 - nist-ai-rmf-readiness.html: AI Risk Management Framework implementation
 
 Updated dashboard:
 - 8 governance service packages on rate card
 - Cross-framework mapping offering ($15-25K)
 - Updated positioning (30+ regulations tracked)
 
 Co-Authored-By: Claude Opus 4.6 (1M context) <noreply@anthropic.com>')
 
 Show description for 01cc7ed
 ...
 committedMar 24, 2026
 
 [01cc7ed](https://github.com/hummbl-dev/hummbl-dev/commit/01cc7edb524675c3a438b7a97913f8bd7c5869e6)
 
 Copy full SHA for 01cc7ed
