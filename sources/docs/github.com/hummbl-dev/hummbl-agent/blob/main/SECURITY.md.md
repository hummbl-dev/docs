# Source: https://github.com/hummbl-dev/hummbl-agent/blob/main/SECURITY.md
...
[History](https://github.com/hummbl-dev/hummbl-agent/commits/main/SECURITY.md)

History

163 lines (108 loc) · 4.97 KB
...
[Raw](https://github.com/hummbl-dev/hummbl-agent/raw/refs/heads/main/SECURITY.md)
...
- Email: [hummbl@proton.me](mailto:hummbl@proton.me) or [reuben@hummbl.io](mailto:reuben@hummbl.io)
...
- `vendor/`: Read-only; PRs reject edits (except README, UPSTREAM\_PINS)
