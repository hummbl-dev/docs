# Source: https://github.com/hummbl-dev/hummbl-agent/blob/main/GOVERNANCE.md
...
[History](https://github.com/hummbl-dev/hummbl-agent/commits/main/GOVERNANCE.md)

History

331 lines (226 loc) · 7.91 KB
...
[Raw](https://github.com/hummbl-dev/hummbl-agent/raw/refs/heads/main/GOVERNANCE.md)
...
- CI rejects PRs modifying vendor code (except README, UPSTREAM\_PINS)
...
- JSON schema versioned at [VERIFY\_HUMMBL\_JSON\_SCHEMA\_v1.0.0.md](https://github.com/hummbl-dev/hummbl-agent/blob/main/docs/specs/VERIFY_HUMMBL_JSON_SCHEMA_v1.0.0.md)
